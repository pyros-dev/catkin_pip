...
project = u'catkin_pip'
copyright = u'2015, 2016 AlexV'
...
htmlhelp_basename = 'catkin_pip_pydoc'
...
texinfo_documents = [
  ('index', 'catkin_pip',
   u'Catkin-pip Documentation',
   u'AlexV', 'catkin_pip', 'catkin_pip.',
   'Miscellaneous'),
]
